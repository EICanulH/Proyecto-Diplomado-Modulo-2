...
Preferemos imprimir dataframes de pandas grandes desde R para una mejor visualización. Observe la diferencia:
...
# Crear nuevas columnas harvest_mes y harvest_anio apartir de harvest_year
...
```{python}
datos[["harvest_year", "harvest_anio", "harvest_mes"]].drop_duplicates().head(10)
```
...
datos2 = datos.dropna(subset=['color2'])
